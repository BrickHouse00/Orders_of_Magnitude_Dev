...
public class FluidTankRenderer {
    ...
    public FluidTankRenderer(long capacity, boolean showCapacity, int xMin, int yMin, int width, int height) {
        this(capacity, showCapacity ? TooltipMode.SHOW_AMOUNT_AND_CAPACITY : TooltipMode.SHOW_AMOUNT, xMin, yMin, width, height);
    }

    private FluidTankRenderer(long capacity, TooltipMode tooltipMode, int xMin, int yMin, int width, int height) {
    ...
    public final void fillTooltip(int mouseX, int mouseY, List<Component> tooltip, FluidStack fluidStack){
        if(area.contains(mouseX, mouseY)){
            fillTooltipOverArea(mouseX, mouseY, tooltip, fluidStack);
        }
    }
    //@Override
    protected void fillTooltipOverArea(int mouseX, int mouseY, List<Component> tooltip, FluidStack fluidStack) {
        long amount = fluidStack.getAmount();
        tooltip.add(new TextComponent(amount+"/"+capacity+" mB"));
    }
